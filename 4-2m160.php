...
<title>4.2M160 | Touch Screen | Senvion</title>

<!-- Meta tags -->
<meta name="robots" content="INDEX,FOLLOW"/>
<link rel="canonical" href="4m-series.php" />
...
<meta property="og:url" content="4m-series.php" />
   ...
   <div class="banner-main">
      <div class="banner-text">
         <div class="container">
            ...
            <p data-aos="fade-down" data-aos-delay="400"><b>Disclaimers</b> - Commercially available from 2025</p>
      ...
      <div class="banner-img">
         <img src="assets/images/product-banner-4.jpg" alt="Product Banner">
      </div>
   </div>
...
<section>
   <div class="container">
    ...
    <div class="video-wrapper">
         ...
         <div class="table-2">
            <table data-aos="fade-down" data-aos-delay="200">
               ...
               <tbody class="table-body">
                  <tr><td>Nominal Power (kW)</td><td>4200</td></tr>
                  ...
                  <tr><td>Operating Temperature range (°C)</td><td>-10 to 45</td></tr>
      ...
      <div class="table-main">
         <div class="table-1">
            <table data-aos="fade-down" data-aos-delay="300">
               ...
               <tbody class="table-body">
                  <tr><td>Diameter (m)</td><td>160.0</td></tr>
                  <tr><td>Rotor Area (m<sup>2</sup>)</td><td>20,108</td></tr>
         ...
         <div class="table-2">
            <table data-aos="fade-down" data-aos-delay="600">
               ...
               <tbody class="table-body">
                  ...
                  <tr><td>Converter Type</td><td>Partial converter DFIG</td></tr>
      ...
      <div class="table-main">
         <div class="table-3">
            <table data-aos="fade-down" data-aos-delay="800">
               <thead>
                  <tr><th colspan="2">Power Curve</th></tr>
               </thead>
               <tbody class="table-body">
                  <tr><td><img src="assets/images/4.1-graph.jpg"></td></tr>
               </tbody>
            </table>
         </div>
      </div>
