...
<section>
   ...
   <div class="product-tab stickynav">
       <ul class="tab-list">
        <li><a href="2m-series.php" class="tab-link">2.7M130*</a></li>
         <li class="active"><a href="3m-series.php" class="tab-link">3.1M130*</a></li>
         <li><a href="4m-series.php" class="tab-link">4.2M160*</a></li>
    </ul>
   </div>
</section>
         ...
         <div class="table-2">
            <table data-aos="fade-down" data-aos-delay="300">
               ...
               <tbody class="table-body">
                  ...
                  <tr><td>Rotor Area (m2)</td><td>11,310</td></tr>
