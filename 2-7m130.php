...
<title>2.7M130 | Touch Screen | Senvion</title>

<!-- Meta tags -->
<meta name="robots" content="INDEX,FOLLOW"/>
<link rel="canonical" href="2m-series.php" />
...
<meta property="og:url" content="2m-series.php" />
...
<section>
   ...
   <div class="product-tab stickynav">
      <ul class="tab-list">
         ...
         <li class="active"><a href="2-7m130.php" class="tab-link">2.7M130*</a></li>
         ...
         <div class="table-1">
            <table data-aos="fade-down" data-aos-delay="200">
               ...
               <tbody class="table-body">
                  <tr><td>Nominal Power (kW)</td><td>2700</td></tr>
      ...
      <div class="table-main">
         <div class="table-1">
            <table data-aos="fade-down" data-aos-delay="400">
               ...
               <tbody class="table-body">
                  <tr><td>Wind Class</td><td>IECS</td></tr>
                  <tr><td>Type Testing</td><td>IECS TEC 61400-22</td></tr>
               </tbody>
            </table>
         </div>
         <div class="table-2">
            <table data-aos="fade-down" data-aos-delay="400">
               ...
               <tbody class="table-body">
                  <tr><td>Type</td><td>Tubular steel tower</td></tr>
                  <tr><td>Height</td><td>Up to 140m</td></tr>
               </tbody>
            </table>
         </div>
      </div>
      ...
      <div class="table-main">
         <div class="table-3">
            <table data-aos="fade-down" data-aos-delay="700">
               <thead>
                  <tr><th colspan="2">Power Curve</th></tr>
               </thead>
               <tbody class="table-body">
                  <tr><td><img src="assets/images/2.7-graph.jpg"></td></tr>
               </tbody>
            </table>
         </div>
      </div>
      <!-- <div class="banner-btn download-brochure">
...
<section>
   <div class="container">
      ...
      <div class="project-list">
         <div class="project-1" data-aos="fade-down" data-aos-delay="100">
            <img src="assets/images/projects/continuum-energy.jpg">
            <p>Customer: Continuum Energy</p>
            <p>Site: Bhavnagar and Jamnagar, Gujarat</p>
            <p>WTG Type: 2.7M130</p>
            <p>Project Size: 68 WTG; 184 MW</p>
         </div>
         <div class="project-1" data-aos="fade-down" data-aos-delay="200">
            <img src="assets/images/projects/tata-power.jpg">
            <p>Customer: Tata Power</p>
            <p>Site: Osmanabad, Maharashtra</p>
            <p>WTG Type: 2.7M130</p>
         ...
         <div class="project-1" data-aos="fade-down" data-aos-delay="400">
          ...
          <div class="project-1" data-aos="fade-down" data-aos-delay="500">
            ...
            <p>Site: Karnataka</p>
            <p>WTG Type: 2.7M130</p>
            <p>Project Size: 18 WTG; 49 MW</p>
         </div>
         <div class="project-1" data-aos="fade-down" data-aos-delay="600">
            <img src="assets/images/projects/haq-steel.jpg">
            <p>Customer: HAQ Steel</p>
            <p>Site: Gujarat</p>
            <p>WTG Type: 2.7M130</p>
         ...
         <div class="project-1" data-aos="fade-down" data-aos-delay="800">
            ...
            <p>Site: Gujarat</p>
            <p>WTG Type: 2.7M130</p>
            <p>Project Size: 1 WTG; 2.7 MW</p>
         </div>
         <div class="project-1" data-aos="fade-down" data-aos-delay="900">
            <img src="assets/images/projects/integrum.jpg">
            <p>Customer: Integrum</p>
            <p>Site: Karnataka</p>
            <p>WTG Type: 2.7M130</p>
            <p>Project Size: 3 WTG; 8.1 MW</p>
         </div>
         <div class="project-1" data-aos="fade-down" data-aos-delay="1000">
            <img src="assets/images/projects/dindigul-steel.jpg">
            <p>Customer: Dindigul Steel Rolling Mills</p>
            <p>Site: Tamil Nadu</p>
            <p>WTG Type: 2.7M130</p>
            <p>Project Size: 4 WTG; 11 MW</p>
         </div>
         <div class="project-1" data-aos="fade-down" data-aos-delay="1100">
            <img src="assets/images/projects/gajananda-jewels.jpg">
            <p>Customer: Gajananda Jewels</p>
            <p>Site: Tamil Nadu</p>
            <p>WTG Type: 2.7M130</p>
            <p>Project Size: 2 WTG; 5.4 MW</p>
         </div>
          <div class="project-1" data-aos="fade-down" data-aos-delay="1200">
            <img src="assets/images/projects/indus-tmt.jpg">
            <p>Customer: Other C&I (Indus TMT; VMC Steel & others)</p>
            <p>Site: Tamil Nadu</p>
            <p>WTG Type: 2.7M130</p>
            <p>Project Size: 6 WTG; 16.2 MW</p>
         </div>
      </div>
   </div>
</section>
